...
#import "FLNormalViewController.h"
#import "FLBrowsePhotoView.h"

#define kPictureW 80
#define kPictureH 120

@interface FLNormalViewController ()<FLBrowsePhotoViewDelegate>
...
@implementation FLNormalViewController
...
- (void)addImgeViews {
    [_imageUrlStrs enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [btn setImage:[UIImage imageNamed:@"placeholder.jpg"] forState:UIControlStateNormal];
